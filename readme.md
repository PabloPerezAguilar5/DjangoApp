This project is a web application developed with Django using Python, HTML, CSS and JavaScript. Coming soon will also include an API REST and the Google Calendar API for the archivement of the dates
